...
class PotentialFieldNode(Node):
    ...
    def tick(self) -> bool:
        ...
        # Danger zone repulsion: add +5.0 potential penalty if any active neighbor is on fire
        neighbor_on_fire = any(n.prev_on_fire for n in self.neighbors if n.id in active_ids)
